               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <input type="text" class="form-control w-50" id="nama" value="<?= $mahasiswa['nama']; ?>"
                                   name="nama" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label for="tmpt_Lahir" class="form-label">Tempat Lahir</label>
                              <input type="text" class="form-control w-50" id="tmpt_Lahir"
                                   value="<?= $mahasiswa['tmpt_Lahir']; ?>" name="tmpt_Lahir" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label for="tgl_Lahir" class="form-label">Tanggal Lahir</label>
                              <input type="date" class="form-control w-50" id="tgl_Lahir"
                                   value="<?= $mahasiswa['tgl_Lahir']; ?>" name="tgl_Lahir" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label>Jenis Kelamin</label>
                              <div class="form-check">
                                   <input class="form-check-input" type="radio" name="jekel" id="Laki - Laki"
                                        value="Laki - Laki" <?php if ($mahasiswa['jekel'] == 'Laki - Laki') { ?> checked=''
                                        <?php } ?>>
                                   <label class="form-check-label" for="Laki - Laki">Laki - Laki</label>
                              </div>
                              <div class="form-check">
                                   <input class="form-check-input" type="radio" name="jekel" id="Perempuan"
                                        value="Perempuan" <?php if ($mahasiswa['jekel'] == 'Perempuan') { ?> checked=''
                                        <?php } ?>>
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                        <option value="Informatika" <?php if ($mahasiswa['jurusan'] == 'Informatika') { ?>
                                        selected='' <?php } ?>>Informatika</option>
                                        <option value="Teknik Listrik" <?php if ($mahasiswa['jurusan'] == 'Teknik Listrik') { ?>
                                        selected='' <?php } ?>>Teknik Listrik</option>
                                   <option value="Teknik Komputer dan Jaringan"
                                        <?php if ($mahasiswa['jurusan'] == 'Teknik Komputer dan Jaringan') { ?> selected=''
                                        <?php } ?>>Teknik Komputer dan Jaringan</option>
                                   <option value="Multimedia" <?php if ($mahasiswa['jurusan'] == 'Multimedia') { ?>
                                        selected='' <?php } ?>>Multimedia</option>
                                   <option value="Rekayasa Perangkat Lunak"
                                        <?php if ($mahasiswa['jurusan'] == 'Rekayasa Perangkat Lunak') { ?> selected=''
                                        <?php } ?>>Rekayasa Perangkat Lunak</option>
                                   <option value="Geomatika" <?php if ($mahasiswa['jurusan'] == 'Geomatika') { ?>
                                        selected='' <?php } ?>>Geomatika</option>
                                   <option value="Mesin" <?php if ($mahasiswa['jurusan'] == 'Mesin') { ?> selected=''
                                        <?php } ?>>Mesin</option>
                              </select>
                         </div>
                         <div class="mb-3">
                              <label for="email" class="form-label">E-Mail</label>
                              <input type="email" class="form-control w-50" id="email" value="<?= $mahasiswa['email']; ?>"
                         ...
                         <div class="mb-3">
                              ...
                              <input type="bapak" class="form-control w-50" id="bapak" value="<?= $mahasiswa['bapak']; ?>"
                                   name="bapak" autocomplete="off" required>
                                   <div class="mb-3">
                              <label for="ibu" class="form-label">Nama Ibu</label>
                              <input type="ibu" class="form-control w-50" id="ibu" value="<?= $mahasiswa['ibu']; ?>"
                                   name="ibu" autocomplete="off" required>
                                   <div class="mb-3">
                              <label for="medsos" class="form-label">Id Medsos</label>
                              <input type="medsos" class="form-control w-50" id="medsos" value="<?= $mahasiswa['medsos']; ?>"
                                   name="medsos" autocomplete="off" required>
                         <hr>
