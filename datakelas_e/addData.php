          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              <label for="bapak" class="form-label">Bapak</label>
                              <input type="bapak" class="form-control w-50" id="bapak" placeholder="Nama Bapak"
                                   name="bapak" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label for="ibu" class="form-label">Ibu</label>
                              <input type="ibu" class="form-control w-50" id="ibu" placeholder="Nama Ibu"
                                   name="ibu" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label for="medsos" class="form-label">Medsos</label>
                              <input type="medsos" class="form-control w-50" id="medsos" placeholder="Masukkan Id Medsos (Bebas)"
